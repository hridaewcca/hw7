//I was having a lot of issues with the sound, couldn't figure it out. Random ball position is working.
...
function preload() {
  soundFormats('mp3');
  pong = loadSound('project-folder/TOASTY.mp3');
  offtable = loadSound('project-folder/YES.mp3');
  gameover = loadSound('project-folder/gameover.mp3');
}
